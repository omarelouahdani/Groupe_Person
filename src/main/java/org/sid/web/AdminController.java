...
public class AdminController {
	...
	public String admins(Model model, @RequestParam(name = "page", defaultValue = "0") int page,
			@RequestParam(name = "motCle", defaultValue = "") String mc) {
	...
	public String cours(Model model, @RequestParam(name = "page", defaultValue = "0") int page,
			@RequestParam(name = "motCle", defaultValue = "") String mc) {
	...
	public String editCour(Model model, Long id) {
	...
	public String editDepartement(Model model, Long id) {
	...
	public String formAdmins(Model model) {
	...
	public String filieres(Model model, @RequestParam(name = "page", defaultValue = "0") int page,
			@RequestParam(name = "motCle", defaultValue = "") String mc) {
